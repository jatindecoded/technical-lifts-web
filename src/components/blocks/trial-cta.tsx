  ...
  return (
    ...
    >
      <div className="container max-w-4xl text-center">
        ...
        <motion.div className="mt-12 flex flex-wrap items-center justify-center gap-6" variants={item}>
          <CTA id="trial" />
          <CTA id="trialSecondary" />
        </motion.div>

        <motion.p variants={item} className="text-text-muted mt-8 text-sm italic opacity-60">
          {TRIAL_CTA.note}
        </motion.p>
      </div>
    </motion.section>
